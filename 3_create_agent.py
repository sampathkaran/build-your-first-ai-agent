...
agent = create_agent(model="gpt-5-nano", tools=tools, system_prompt=system_prompt)

#invoke and test it
#response = agent.invoke({"messages": [{"role": "human", "content": "What is the current weather in singapore?"}]})
